...
def parseArgs(argv):
	parser = argparse.ArgumentParser(prog="process.py calling", description=USAGE, formatter_class=argparse.RawDescriptionHelpFormatter)
	...
	parser.add_argument('--sample', help = "The name of the sample that is noted.", default = "None", type = str)
