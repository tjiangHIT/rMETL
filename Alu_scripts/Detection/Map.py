...
USAGE="""\
	Maps the potential TE seqs to the TE refs.
...
def parseArgs(argv):
	...
	parser.add_argument("input", metavar="FASTA", type=str, help="Input TE seqs to be mapped")
	parser.add_argument("TE_Ref", type=str, help="the reference genome(fasta format)")
...
def run(argv):
	...
	# print args
	starttime = time.time()
	call_ngmlr(args.input, args.TE_Ref, args.presets, args.threads, args.temp_dir, args.subread_length, args.subread_corridor)
